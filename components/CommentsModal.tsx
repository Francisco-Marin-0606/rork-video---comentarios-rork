...
const styles = StyleSheet.create({
  ...
  inputContainer: { flexDirection: 'row', alignItems: 'flex-end', paddingHorizontal: 16, paddingVertical: Platform.OS === 'android' ? 4 : 12, borderTopWidth: 1, borderTopColor: '#1f1f1f', backgroundColor: '#1a1a1a' },
  textInput: { flex: 1, backgroundColor: '#222427', borderRadius: Platform.OS === 'android' ? 22 : 28, paddingHorizontal: 16, paddingVertical: Platform.OS === 'android' ? 6 : 12, borderWidth: 1, borderColor: '#2f3236', color: '#fff', fontSize: 14, maxHeight: 84, marginRight: Platform.OS === 'android' ? 8 : 12 },
